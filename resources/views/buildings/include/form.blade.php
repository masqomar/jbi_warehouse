    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-select" name="status" id="status" class="form-control" required>
                ...
                <option value="1" {{ isset($building) && $building->status == '1' ? 'selected' : (old('status') == '1' ? 'selected' : '') }}>{{ __('True') }}</option>
                <option value="0" {{ isset($building) && $building->status == '0' ? 'selected' : (old('status') == '0' ? 'selected' : '') }}>{{ __('False') }}</option>
            </select>
        </div>
    </div>
</div>